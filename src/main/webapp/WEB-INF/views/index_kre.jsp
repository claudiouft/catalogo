...
<head>
   ...
   <link rel="stylesheet" href="recursos/css/vendor.min.css">
...
<body>
      ...
      <div class="row items">
         ...
         <div id="portfolio-wrapper" class="bgrid-fourth s-bgrid-third tab-bgrid-half">
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-01">
	                  <img src="recursos/images/portfolio/underwater.jpg" alt="Underwater">
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-02">
                     <img src="recursos/images/portfolio/hotel.jpg" alt="Hotel Sign">
                     <div class="overlay">
                      <div class="portfolio-item-meta">
          					   <h5>Hotel Sign</h5>
                           <p>Branding</p>
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-03">
                     <img src="recursos/images/portfolio/beetle.jpg" alt="Beetle">                        
                     <div class="overlay">
                      <div class="portfolio-item-meta">
          					   <h5>Beetle</h5>
                           <p>Webdesign</p>
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-04">
                     <img src="recursos/images/portfolio/banjo-player.jpg" alt="Banjo Player">
                     <div class="overlay">
                      <div class="portfolio-item-meta">
          					   <h5>Banjo Player</h5>
                           <p>Photography</p>
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-05">
                   <img src="recursos/images/portfolio/lighthouse.jpg" alt="Lighthouse">
                     <div class="overlay">
                      <div class="portfolio-item-meta">
          					   <h5>Lighthouse</h5>
                           <p>Web Development</p>
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-06">
                     <img src="recursos/images/portfolio/girl.jpg" alt="Girl Stuff">
                     <div class="overlay">
                      <div class="portfolio-item-meta">
          					   <h5>Girl Stuff</h5>
                           <p>Photography</p>
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-07">                        
                     <img src="recursos/images/portfolio/coffee.jpg" alt="Coffee Cup">                       
                     <div class="overlay">
                      <div class="portfolio-item-meta">
          					   <h5>Coffee Cup</h5>
                           <p>Branding</p>
            ...
            <div class="bgrid folio-item">
               <div class="item-wrap">
                  <a href="#modal-08">
                     <img src="recursos/images/portfolio/judah.jpg" alt="Judah">
                     <div class="overlay">
                      	<div class="portfolio-item-meta">
        					      <h5>Judah</h5>
                           <p>Webdesign</p>
         ...
         <div id="modal-01" class="popup-modal mfp-hide">
		      ...
		      <div class="media">
	      		<img src="recursos/images/portfolio/modals/m-underwater.jpg" alt="Underwater" />
	      	</div>
         ...
         <div id="modal-02" class="popup-modal mfp-hide">
		      ...
		      <div class="media">
	      		<img src="recursos/images/portfolio/modals/m-hotel.jpg" alt="Hotel Sign" />
	      	</div>
         ...
         <div id="modal-03" class="popup-modal mfp-hide">
		      ...
		      <div class="media">
	      		<img src="recursos/images/portfolio/modals/m-beetle.jpg" alt="" />
	      	</div>
			...
			<div id="modal-04" class="popup-modal mfp-hide">
		      ...
		      <div class="media">
	      		<img src="recursos/images/portfolio/modals/m-banjo-player.jpg" alt="" />
	      	</div>
	      ...
	      <div id="modal-05" class="popup-modal slider mfp-hide">	
	      	...
	      	<div class="media">
	      		<img src="recursos/images/portfolio/modals/m-lighthouse.jpg" alt="" />
	      	</div>      	
	      ...
	      <div id="modal-06" class="popup-modal mfp-hide">
		      ...
		      <div class="media">
	      		<img src="recursos/images/portfolio/modals/m-girl.jpg" alt="" />
	      	</div>	
	      ...
	      <div id="modal-07" class="popup-modal mfp-hide">
		      ...
		      <div class="media">
	      		<img src="recursos/images/portfolio/modals/m-coffee.jpg" alt="" />
	      	</div>	
	      ...
	      <div id="modal-08" class="popup-modal mfp-hide">
		      ...
		      <div class="media">
	      		<img src="recursos/images/portfolio/modals/m-judah.jpg" alt="" />
	      	</div>	
         ...
         <div id="team-wrapper" class="bgrid-fourth s-bgrid-third tab-bgrid-half mob-bgrid-whole group">
            ...
            <div class="bgrid member">
					...
					<div class="member-pic">
						<img src="recursos/images/team/member01-k.jpg" alt=""/>
                 	<div class="mask"></div>       	
               </div>
            ...
            <div class="bgrid member">
					...
					<div class="member-pic">
                  <img src="recursos/images/team/member03-k.jpg" alt=""/>
               	<div class="mask"></div>  
               </div>
               <div class="member-name">
                  <h3>Sasuke Uchiha</h3>
            ...
            <div class="bgrid member">
					...
					<div class="member-pic">
						<img src="recursos/images/team/member04-k.jpg" alt=""/>
                 	<div class="mask"></div>                          	
               </div>
               <div class="member-name">
            ...
            <div class="bgrid member">
					...
					<div class="member-pic">
                 	<img src="recursos/images/team/member05-k.jpg" alt=""/>
                 	<div class="mask"></div>  
               </div>
               <div class="member-name">
                  <h3>Sakura Haruno</h3>
            ...
            <ul class="slides">
               <li>
                  ...
                  <div class="testimonial-author">
                    	<img src="recursos/images/avatars/avatar-1.jpg" alt="Author image">
               ...
               <li>                       
                  ...
                  <div class="testimonial-author">
                    	<img src="recursos/images/avatars/avatar-2.jpg" alt="Author image">
                    	<div class="author-info">
                    		John Doe
   ...
   <script src="recursos/js/jquery-migrate-1.2.1.min.js"></script>
   ...
   <script src="recursos/js/jquery.fittext.js"></script>
