...
<meta charset="utf-8">
<title>Elas Demais</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content="">
<meta name="author" content="">
<!-- Le styles -->
<link href="resources/tquasar/assets/css/bootstrap.min.css" rel="stylesheet">
<link href="resources/tquasar/assets/css/font-awesome.min.css" rel="stylesheet">
<link href="resources/tquasar/assets/css/style.css" rel="stylesheet">
<link href="resources/tquasar/assets/css/animate.css" rel="stylesheet">
<link href="resources/tquasar/assets/css/skin-blue.css" rel="stylesheet">
<!-- Le fav -->
<link rel="shortcut icon" href="resources/tquasar/assets/ico/favicon.png">
<!--[if lt IE 9]>
<style>
...
<div class="container">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#top-section">ELAS DEMAIS - Gallery</a>
	</div>
	<!-- Collect the nav links, forms, and other content for toggling -->
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav navbar-right">
			<li class="active"><a class="sscroll" href="#top-section">Home1</a></li>
			<li><a class="sscroll" href="#Section-1">Features</a></li>
			<li><a class="sscroll" href="#Section-2">Gallery</a></li>
			<li><a class="sscroll" href="#Section-3">Reviews</a></li>
			<li><a class="sscroll" href="#Section-4">Team</a></li>
			<li><a class="sscroll" href="#Section-5">Pricing</a></li>
			<li><a class="sscroll" href="#Section-6">Contact</a></li>
		</ul>
	</div>
	<!-- /.navbar-collapse -->
</div>
...
<!-- INICIO CARROSEL -->
<div class="jumbotron">
	<div id="carousel_intro" class="carousel slide fadeing" data-ride="carousel">
		...
		<div class="testimonials-slider">
			<div class="slide">
				<div class="testimonials-carousel-thumbnail">
					<img width="120" alt="" src="resources/tquasar/assets/img/avatar.jpg">
				</div>
...
<div class="row animated fadeInUpNow">
	<div class="col-lg-8 col-md-offset-2">
		<form action="#" name="MYFORM" id="MYFORM">
			...
			<img src="resources/tquasar/contact/refresh.jpg" alt="" id="refresh" style="width:45px;"/>
			<!-- <img src="resources/tquasar/contact/get_captcha.php" alt="" id="captcha" style="height:45px;"/> -->
			<br/>
...
<script src="resources/tquasar/assets/js/jquery.min.js" type="text/javascript"></script>
<script src="resources/tquasar/assets/js/bootstrap.js"></script>
<script src="resources/tquasar/assets/js/jquery.parallax-1.1.3.js" type="text/javascript"></script>
<script src="resources/tquasar/assets/js/jquery.localscroll-1.2.7-min.js" type="text/javascript"></script>
<script src="resources/tquasar/assets/js/jquery.scrollTo-1.4.6-min.js" type="text/javascript"></script>
<script src="resources/tquasar/assets/js/jquery.bxslider.min.js"></script>
<script src="resources/tquasar/assets/js/jquery.placeholder.js"></script>
<script src="resources/tquasar/assets/js/modernizr.custom.js"></script>
<script src="resources/tquasar/assets/js/toucheffects.js"></script>
<script src="resources/tquasar/assets/js/animations.js"></script>
<script src="resources/tquasar/assets/js/init.js"></script>
</body>
</html>